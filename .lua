...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "FirstKeyBlya" then   
screenGui:Destroy()

loadstring(game:HttpGet("https://raw.githubusercontent.com/Aisen11394/Scriptb/refs/heads/main/.lua"))()
  
  end
end)

GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://raw.githubusercontent.com/Aisen11394/Key/refs/heads/main/.lua") 
end) 
